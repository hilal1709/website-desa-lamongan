...
export const defaultCmsPages: CmsPageContent[] = [
    ...
    sections: [
      {
        ...
        label: "Kartu layanan",
        items: [
          { title: "Surat Keterangan", description: "Domisili, usaha, tidak mampu, dan surat pengantar.", href: "/layanan-digital" },
          { title: "Kependudukan", description: "Administrasi KTP, KK, kelahiran, dan pindah datang.", href: "/layanan-digital" },
          { title: "Kesehatan Warga", description: "Pendaftaran posyandu dan informasi layanan kesehatan.", href: "/stunting" },
          { title: "Izin Usaha Mikro", description: "Konsultasi dan surat keterangan usaha desa.", href: "/layanan-digital" },
        ],
      },
      {
        key: "flow",
      ...
      },
      {
        ...
        items: [
          { title: "Surat Keterangan Domisili", meta: "Diajukan 19 Agustus 2025", detail: "Selesai" },
          { title: "Surat Pengantar KTP", meta: "Diajukan 21 Agustus 2025", detail: "Diproses" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    description: "Sampaikan keluhan, laporan, atau aspirasi Anda. Identitas pelapor dijaga dan laporan akan ditindaklanjuti.",
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Riwayat aduan",
        items: [
          { title: "Jalan berlubang di RT 04", meta: "Infrastruktur - 20 Agustus 2025", detail: "Diproses" },
          { title: "Tumpukan sampah bantaran sungai", meta: "Lingkungan - 15 Agustus 2025", detail: "Selesai" },
          { title: "Lampu jalan mati", meta: "Fasilitas umum - 10 Agustus 2025", detail: "Selesai" },
        ],
      },
    ],
  },
