    ...
    <header ref={root} className="border-b border-slate-200 bg-white pt-7 sm:pt-9">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-5 border-b-4 border-slate-950 pb-6 sm:flex-row sm:items-end sm:justify-between sm:pb-7">
          <div><p className="news-masthead-kicker flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-emerald-700"><Radio size={14} className="animate-pulse" /> Liputan Desa</p><h1 className="news-masthead-title mt-2 text-4xl font-black tracking-[-0.06em] text-slate-950 sm:text-5xl">KEDUNGREJO <span className="text-emerald-700">NEWS</span></h1></div>
