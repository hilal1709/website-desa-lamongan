...
const menu: { icon: LucideIcon; label: string; href: string; module: CmsModule }[] = [
  ...
  { icon: FileText, label: "Layanan & Pengajuan", href: "/admin/layanan", module: "SERVICE_CATALOG" }, { icon: FileText, label: "Antrian Layanan", href: "/admin/antrian", module: "SERVICE_SUBMISSIONS" }, { icon: MessageSquare, label: "Kelola Aduan", href: "/admin/aduan", module: "COMPLAINTS" }, { icon: Settings, label: "Pengaturan", href: "/admin/pengaturan", module: "SETTINGS" },
]
