...
export function AdminSidebar() {
  ...
  return <>
    ...
    <aside data-admin-sidebar className="hidden w-[280px] rounded-b-[28px] border border-emerald-900/10 bg-slate-950 p-4 text-white shadow-xl shadow-emerald-950/10 lg:fixed lg:inset-y-0 lg:left-[max(1.5rem,calc((100vw-1500px)/2))] lg:z-30 lg:block lg:h-svh">
