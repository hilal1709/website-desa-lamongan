...
const menu: { icon: ComponentType<{ className?: string }>; label: string; href: string; module: CmsModule }[] = [
  ...
  { icon: FileText, label: "Layanan & Pengajuan", href: "/admin/layanan", module: "SERVICE_CATALOG" }, { icon: MessageSquare, label: "Kelola Aduan", href: "/admin/aduan", module: "COMPLAINTS" }, { icon: Settings, label: "Pengaturan", href: "/admin/pengaturan", module: "SETTINGS" }, { icon: Settings, label: "Akun & Hak Akses", href: "/admin/akses", module: "ACCOUNT_ACCESS" }, { icon: ShieldAlert, label: "Keamanan akun", href: "/admin/keamanan", module: "ACCOUNT_SECURITY" }, { icon: ShieldAlert, label: "Audit Log", href: "/admin/audit-log", module: "AUDIT_LOG" },
]
