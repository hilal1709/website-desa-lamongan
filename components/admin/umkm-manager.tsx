...
type ApiBusiness = Omit<Business, "dusun" | "registeredAt"> & { dusun?: string | null; registeredAt?: string | null; createdAt?: string | null }
...
const dateInput = (value: unknown) => typeof value === "string" && !Number.isNaN(Date.parse(value)) ? value.slice(0, 10) : today()
const normalizeBusiness = (business: ApiBusiness): Business => ({ ...business, dusun: business.dusun?.trim() || "Belum ditentukan", registeredAt: dateInput(business.registeredAt ?? business.createdAt) })
