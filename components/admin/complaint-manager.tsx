...
export function ComplaintManager({ initialComplaints }: { initialComplaints: Complaint[] }) {
  ...
  useEffect(() => {
    if (isInitialLoad.current) { isInitialLoad.current = false; if (initialComplaints.length) return }
