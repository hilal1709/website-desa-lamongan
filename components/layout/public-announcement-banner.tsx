...
export function PublicAnnouncementBanner({ initialAnnouncement }: { initialAnnouncement: string | null }) {
  ...
  return <aside role="status" aria-label="Pengumuman desa" className="relative z-40 border-b border-emerald-200 bg-emerald-50 text-emerald-950"><div className="mx-auto flex max-w-[1400px] items-center justify-center gap-2 px-5 py-3 text-center text-sm font-semibold"><Megaphone className="size-4 shrink-0 text-emerald-700" aria-hidden="true" /><p>{message}</p></div></aside>
}
