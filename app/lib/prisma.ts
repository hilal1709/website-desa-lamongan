...
const prismaSchemaVersion = "20260825230000_add_child_health"
...
export const prisma = cachedPrisma && "adminUser" in cachedPrisma && "role" in cachedPrisma && "rolePermission" in cachedPrisma && "umkm" in cachedPrisma && "resident" in cachedPrisma && "populationEvent" in cachedPrisma && "elderly" in cachedPrisma && "child" in cachedPrisma && "villageService" in cachedPrisma && globalForPrisma.prismaUsesTls === usesTls && globalForPrisma.prismaSchemaVersion === prismaSchemaVersion ? cachedPrisma : createPrismaClient();
