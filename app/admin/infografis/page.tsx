...
export default async function AdminInfografisPage() {
  ...
  return <AdminInfographicMotion><section data-admin-reveal aria-label="Kependudukan dan infografis" className="py-1 sm:py-2"><AdminPageHeader eyebrow="CMS Kependudukan" title="Kependudukan & infografis" description="Kelola jumlah jiwa dan KK resmi melalui data dasar per dusun serta peristiwa penduduk. Profil warga hanya dipakai untuk visual pendidikan dan mata pencaharian." /><div className="mt-5 space-y-6"><CmsInfographicWorkflow /><div data-cms-infographic-section><CmsInfographicModules initialEvents={initialEvents} initialBalances={initialBalances} initialResidents={initialResidents} /></div></div></section></AdminInfographicMotion>
}
